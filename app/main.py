...
def callback_query(call):
    ...
    if  call.data == 'raspredelenie':
        ...
        with open('файлеки/ПГАС.docx', 'rb') as document:
            bot.send_document(call.message.chat.id, document)
        with open('файлеки/формы_представлений_ПГАС.docx', 'rb') as document:
            bot.send_document(call.message.chat.id, document)
        with open('файлеки/Размер_стипендий_2023-2024.pdf', 'rb') as document:
            bot.send_document(call.message.chat.id, document)
        ...
        with open('файлеки/Приложение1_Физ_ра.docx', 'rb') as document:
            bot.send_document(call.message.chat.id, document)
        with open('файлеки/Приложение2_Физ_ра.docx', 'rb') as document:
            bot.send_document(call.message.chat.id, document)
