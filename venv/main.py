    ...
    if  call.data == 'raspredelenie':
        ...
        for i in range(1, 7):
            if i == 1:
                ...
                media.append(InputMediaPhoto(open(f'УП{i}.png', 'rb'), caption=caption))
            else:
              
                media.append(InputMediaPhoto(open(f'academic_calendar{i}.png', 'rb')))
        ...
        for i in range(1, 7):
            if i == 1:
                ...
                media.append(InputMediaPhoto(open(f'УП{i}.png', 'rb')))
